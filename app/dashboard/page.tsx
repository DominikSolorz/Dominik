...
export default function Dashboard(){
 ...
 return <main className="dashboardShell">
  <aside className="dashSidebar"><Brand compact/><nav><button className="active"><CreditCard size={18}/>Dashboard</button><button><BellRing size={18}/>Alerty</button><button><Volume2 size={18}/>Głosówki</button><button><Goal size={18}/>Cele</button><button><Link2 size={18}/>Integracje</button><button><Settings2 size={18}/>Ustawienia</button></nav><button onClick={logout} className="logout"><LogOut size={17}/>Wyloguj</button></aside>
